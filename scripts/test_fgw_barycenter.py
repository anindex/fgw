...
A, C, log = fgw_barycenters(sizebary, Ys, Cs, ps, epsilon=0.5, warmstartT=True, seed=int(time.time()), loss_fun='square_loss',
                            alpha=0.5, tol=1e-2, max_iter=100, solver='BAPG', log=True, verbose=True, numItermax=10)
